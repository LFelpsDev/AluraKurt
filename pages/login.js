...
import FlexContainer from '../src/components/FlexContainer/index'
    ...
    <FlexContainer>
      <div className="loginScreen">
        ...
        <section className="formArea">
          ...
          >
            {githubUser.length === 0 ? " " : <img src={`https://github.com/${githubUser}.png`} />}
            <p>
            ...
            {githubUser.length === 0 ?  " " : <button type="submit">Login</button>}
          </form>
